...
L.Control.SideBySide = L.Control.extend({
  ...
  _updateClip: function () {
    ...
    if (this._leftLayer) {
	  //console.log(this)
	  jQuery.each(this._leftLayer._layers, function(i, val) {
		//console.log(i)
		//if(val._tilesToLoad > 0){
		//this._leftLayer.getContainer().style.clip = clipLeft
		//console.log(this._leftLayer._layers[i]._tilesToLoad)
		//console.log(historicSatelliteSwiperAdded)
		if (historicSatelliteSwiperAdded){
			this._container.style.clip = clipLeft
		}
	  })
    }
    if (this._rightLayer) {
