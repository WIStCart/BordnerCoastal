	...
	if (pointTypeSelected == "all"){
		...
		for (var i=0; i < pointLegend.length; i++){
			...
			if (pointTypeSelected.toLowerCase() === thisPointType.toLowerCase()){
				...
				var thisStyle = "[point_type='" + thisPointType + "']{marker-opacity: 1; marker-file: url(" + pointLegend[i].icon + "); marker-allow-overlap: true; marker-opacity: 1;[zoom =7]{marker-width:4;}[zoom <9]{ marker-width:4;}[zoom >=9]{marker-width:8;}[zoom >=10]{marker-width:8;}[zoom >=11]{marker-width:8;}[zoom >=12]{marker-width: 10;}[zoom >=13]{marker-width: 12;  marker-allow-overlap: false;}[zoom >=14]{marker-width: 14;}[zoom >=15]{marker-width: 16;}[zoom >=16]{marker-width: 19;}[zoom >=17]{marker-width: 21;}[zoom >=18]{marker-width: 23;} "+ pointLegend[i].otherCSS 
				if (window["basemapParam"] == 'satellite'){
